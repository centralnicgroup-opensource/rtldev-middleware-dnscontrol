...
// CNRClient describes a connection to the hexonet API.
...
func init() {
	...
	providers.RegisterRegistrarType("CNR", newReg)
	providers.RegisterDomainServiceProviderType("CNR", fns, features)
}
